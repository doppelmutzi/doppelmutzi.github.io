...
Otherwise, you have to use [noHoist](https://yarnpkg.com/blog/2018/02/15/nohoist/) to use otherwise incompatible 3rd party dependencies working in the _Mono-Repo_ environment.
